...
The goal of this analysis was to find the narrative roles and their evolution for three side characters in a TV series. We first looked into doing this analysis for the show Breaking Bad, however we quickly realized that the side characters in Breaking Bad have few lines. We then pivoted to trying to find a show with more significant side characters. That's when we stumbled upon Game of Thrones. Many characters in Game of Thrones have over 400 lines of dialog, which is plenty for our analysis. We then chose three of those side characters for our analysis: Petyr Baelish, Samwell Tarly and Theon Greyjoy. Our analysis suggests that, for these three characters, the show primarily uses dialogue for exposition, as well as relationship development and planning, rather than for depicting violence or overt political debate. Furthermore, each character has a clear “functional role” in the discourse. Take Samwell Tarly as an example, his frequent talk of Information/Lore and Trivial matters illustrate his role as a lore-keeper who explains the White Walker threat and the institutional world of the Night’s Watch and the Citadel. Simultaneously, his trivial talk (e.g. “library”, “walks”, “work”) grounds scenes in everyday life. Petyr Baelish and Theon Greyjoy, also display similarly distinct linguistic patterns that define their specific archetypes within the narrative.

\section{Data}

\subsection{Data Acquisition and Description}

We initially evaluated a comprehensive Game of Thrones dataset; however, upon further inspection, we found various flaws in the dataset, including scene descriptions and non-standardized speaker labels, such as “WILL (whispering)”. While we considered cleaning the data programmatically, the variation in naming conventions increased the risk of parsing errors. To ensure data integrity, we opted for an alternate dataset from Kaggle, which was void of scene descriptions and had more consistent speaker labels. When compared to screenplays we had looked at for other TV series, a precompiled dataset was selected for its organized and complete structure, providing clear separation between speakers and dialogues, thereby eliminating the need to remove scene descriptions. The dataset contains the entire chronological transcript for all eight seasons of Game of Thrones, totalling 23,911 entries. Each entry contains the release date, season number, episode number, episode title, character and dialogue. 
